...
if choice == "Jason Noble":
    ...
    if choice == "NobleKing26":
        ...
        if choice1 == "yes":
            ...
            Post.post_id += 1
            choice = input ("Would you like to start your order?) (yes/no): ")
            if choice == "yes":
    ...
    if choice=="hard":
        ...
        print("soft shell")
    choice = input("how many tacos would you like? one, two $0.50, three $1.00, four $1.50, five $2.00, or six $2.50: ").strip()
    if choice == "one":
        print("one taco")
    elif choice == "two":
...
#Iteration 4
    choice = input("would you like any sauces for your tacos? ").strip().lower()
    if choice == "yes":
        choice = input("what sauce would you like? buffalo sauce packets, salsa $0.25, guacamole $0.25, or melted cheese $0.50: ").strip().lower()
...
# final checkout prompts
        ...
        if choice == "yes":
            ...
            if choice == "yes":
                ...
                if choice == "yes":
                    print("large beverage $2.25 and large bag of chips $2.00 added intp order")
