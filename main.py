...
while True:
    ...
    # TODO 3.2.1 (lists) - add the item ordered to the list of items ordered
    if choice == "steak":
        print("Steak $6.25")
        Total_cost += 6.25
    elif choice == "chicken":
        ...
        pass # TODO: handle error or notify user we're skipping
    ...
    # TODO: 3.1.3 (Combo Menu) - make sure to accept and convert user input into a number for easier multiplying of cost
    ...
    if choice == "yes":
        ...
        print("let's review the menu again, shall we?")
